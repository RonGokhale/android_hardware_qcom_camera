...
receiveCompleteJpegPicture(jpeg_event_t event)
{
    ...
    if (mSnapshotState == SNAPSHOT_STATE_JPEG_COMPLETE_ENCODE_DONE) {
...
void QCameraStream_Snapshot::stopCapture(void)
{
    mm_camera_ops_type_t ops_type;
    status_t ret = NO_ERROR;
